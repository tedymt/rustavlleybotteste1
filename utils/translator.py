...
TICKET_UI = {
    ...
    "de": {
        ...
        "closed_dm": "Support beendet auf **{guild}**.\nProtokoll: `{code}` | Dauer: {duration}\n\nZusammenfassung des Tickets im Anhang. Siehe alles, was besprochen wurde.",
    ...
    "it": {
        ...
        "closed_dm": "Supporto concluso su **{guild}**.\nProtocollo: `{code}` | Durata: {duration}\n\nRiepilogo del ticket allegato. Consulta tutto ciò che è stato discusso.",
