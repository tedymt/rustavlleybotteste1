...
TICKET_UI = {
    ...
    "fr": {
        ...
        "closed_dm": "Assistance terminée sur **{guild}**.\nProtocole : `{code}` | Durée : {duration}\n\nCopie du transcript jointe (HTML). Téléchargez et ouvrez dans votre navigateur.",
    ...
    "de": {
        ...
        "closed_dm": "Support beendet auf **{guild}**.\nProtokoll: `{code}` | Dauer: {duration}\n\nTranskript als Anhang (HTML). Laden Sie herunter und öffnen Sie im Browser.",
